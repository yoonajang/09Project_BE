...
const credentials = {
  key: fs.readFileSync(__dirname + './httpskey/private.key', 'utf8'),
  cert: fs.readFileSync(__dirname + './httpskey/certificate.crt', 'utf8'),
  ca: fs.readFileSync(__dirname + './httpskey/ca_bundle.crt', 'utf8'),
}
